        ...
        <div>
          ...
          <Row className='justify-content-center'>
            <Col className='col-sm-3 text-center'>
              <button id='drivers' className='justify-content-center' onClick={() => openDrivers()} style={{marginLeft: "25%", backgroundColor: "#fff0f0"}}>Drivers</button>
            </Col>
          </Row>
          <br></br>
          <Table id='table_standings' style={{ border: "1px solid black", borderCollapse: "collapse", backgroundColor: "#fff0f0", width: "50%", margin: "auto", fontSize: "20px"}}>
            <thead>
              <tr>
